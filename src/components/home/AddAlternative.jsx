...
const AddAlternative = () => {
  ...
  return (
    <div className="mt-12 grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-8 lg:gap-12 items-center">
      <div>
        <p className="text-xl md:text-2xl lg:text-3xl xl:text-4xl text-redColor roboto-bold mb-4">
          {t("Add a Boycott Brand")}
        </p>
        <Link
          to="/add-product"
          className="bg-redColor p-3  rounded-lg w-[180px] capitalize text-white flex items-center justify-center gap-4"
        >
          <p>{t("Add now")}</p>
          {i18n.language === "ar" ? (
